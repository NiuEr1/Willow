...
exports.run = async (client, message, args) => {
  try {
    ...
    if (args[0] === 'voice') {
      ...
      if (getChannel === 'null') return message.reply('Untuk mengaktifkan Log silahkan ketik n!logs').then(msg => msg.delete({ timeout: 5000 }));
...
exports.help = {
  ...
  usage: 'n!bisu <user> [reason]',
  example: 'n!bisu @juned spam'
}