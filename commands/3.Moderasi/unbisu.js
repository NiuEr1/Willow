...
exports.run = async (client, message, args) => {
  try {
    ...
    if (args[0].toLowerCase() === 'voice') {
      ...
      if (getChannel === 'null') return message.reply('Untuk mengaktifkan Log, Silahkan jalankan perintah n!logs').then(msg => msg.delete({ timeout: 5000 }));
...
exports.help = {
  ...
  usage: 'n!unbisu <user/id>',
  example: 'n!unbisu @juned'
}