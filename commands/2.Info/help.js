...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
    ...
    const embed = new MessageEmbed()
      ...
      .setTimestamp()
      .setFooter(`© 2021, Kitty Cafe bot • Total: ${client.commands.size} commands`, client.user.avatarURL)
      ...
      .setTitle(`<a:KPH_zdm:855072473099403304> ${client.user.username}-Bot Command List <a:KPH_zdm:855072473099403304>`)
    ...
    if (!client.commands.has(cmd) || !client.commands.get(client.aliases.get(cmd))) {
      message.channel.send({ embed: { color: 0xcc5353, description: "command tidak ditemukan kak." } })
    }
  }
}
