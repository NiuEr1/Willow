...
exports.run = async (client, message, args) => {
  try {
    ...
    if (getChannel === "null") return message.reply('Channel Belum diatur, silahkah atur dengan menjalankan perintah n!logs').then(a => a.delete({ timeout: 5000 }));
